...
<div class="bg-green-400 bg-[url('assets/fruit.png')] bg-cover p-10 h-[40vh] bg-no-repeat font-semibold     mx-auto text-center  flex-auto  ">
  <h1 class="xl:mt-24 mt-16    text-white text-3xl">Fresh Fruits</h1>
</div>

<div class="px-16 py-8">
  <h4 class="text-white text-lg">Fresh Fruits:</h4>
...
try
{
     ...
     ResultSet rs=st.executeQuery("select * from products where category='fruit'");
  while(rs.next())
  { 
%>
            <!-- Product Card Start  -->
