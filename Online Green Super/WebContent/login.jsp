...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
  <form action="loginAction.jsp" method="post" class="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
    <!-- left side -->
    <div class="flex flex-col justify-center p-8 md:p-14">
      ...
      <!-- Existing checkbox and forgot password section -->
      <div class="flex justify-between w-full py-4">
        <div class="mr-24">
          <input type="checkbox" name="ch" id="ch" class="mr-2" />
          <span class="text-md text-green-500">Remember</span>
        </div>
        <a href="forgotPassword.jsp"><span class="font-bold text-md text-green-500">Forgot password</span></a>
      </div>
      <!-- Existing sign-in button -->
      <input type="submit" value="login"  class="w-full bg-green-500 text-white p-2 rounded-lg mb-6 hover:bg-black hover:text-green-500 black hover:border hover:border-gray-300">
...
<div class="bg-gray-800 py-8 flex items-center justify-center mx-auto">
  <% String msg = request.getParameter("msg"); if("notexist".equals(msg)) { %>
    <h1 class="font-sans text-2xl font-bold text-white">Incorrect Email or Password</h1>
  <% } %> 
