...
<div class="bg-green-400 bg-[url('assets/veg.png')] bg-cover p-10 h-[40vh] bg-no-repeat font-semibold     mx-auto text-center  flex-auto  ">
  <h1 class="xl:mt-24 mt-16    text-white text-3xl">Fresh Vegitables</h1>
</div>

<div class="px-16 py-8">
  <h4 class="text-white text-lg">Fresh Vegitables:</h4>
...
try
{
     ...
     ResultSet rs=st.executeQuery("select * from products where category='vegitables'");
  while(rs.next())
  { 
%>
            <!-- Product Card Start  -->
