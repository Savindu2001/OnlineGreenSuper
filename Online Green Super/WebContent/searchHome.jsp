...
<div class="px-16 py-8">
  <h4 class="text-white text-lg">Results:</h4>
...
<div class="mx-auto flex justify-center items-center w-full h-min">
  <h1 class="text-3xl ml-5 font-bold text-white">Sorry! Nothing to Show</h1>
</div>
