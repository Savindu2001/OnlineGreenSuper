...
<div class="bg-green-800 bg-[url('assets/ads1.jpg')] bg-cover p-10 h-[40vh] bg-no-repeat font-semibold     mx-auto text-center  flex-auto  ">
  <div class="justify-items-center">
      <div class="relative">
      <form action="searchHome.jsp" method="post" class="items-center pt-12">
        <input type="text" placeholder="Search What Do You Want?" name="search" class="px-6 py-4 w-[500px]  border focus:outline-none focus:border-green-500">
        <button type="submit" class="bg-green-600 py-2 px-5 ">
          <i class="bi bi-search text-3xl text-white font-bold "></i>
        </button></form>
      </div>
      </div>
</div>
...
<div class="px-16 py-8">
  <h4 class="text-white text-lg">Products:</h4>
